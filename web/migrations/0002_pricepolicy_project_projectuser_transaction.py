# Generated by Django 3.2.11 on 2022-01-29 13:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.CharField(blank=True, max_length=255, null=True, verbose_name='任务描述')),
                ('use_space', models.IntegerField(default=0, verbose_name='任务相关文件已使用空间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.project', verbose_name='任务')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.userinfo', verbose_name='领取任务者')),
            ],
        ),
    ]

...
<img src="http://gitee.com/leoschopen/picture/raw/master/null/image-20220203113146835.png" alt="image-20220203113146835" style="zoom:67%;" />
...
- 解决点击按钮无法跳转至页面的问题 
  ...
  已解决，原因是因为auth.py的中间件中设置了除了自己外的其他任务不可以查看细节而进行刷新操作
